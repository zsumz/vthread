//! The retained bounded MPSC algorithm, shared verbatim with modeled atomics.

use super::{AtomicU64, AtomicUsize, Ordering, ParkToken, TaskId, TaskKey, WakeCause, WakeNotice};
...
#[repr(align(64))]
pub(super) struct Cursor(AtomicUsize);
...
pub(crate) struct WakeQueue {
    slots: Box<[Slot]>,
    pub(super) head: Cursor,
    pub(super) consumer: Cursor,
}
...
#[cfg(test)]
#[path = "wake_queue_core_test.rs"]
mod wake_queue_core_test;
