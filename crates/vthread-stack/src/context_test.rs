...
use super::{FiberCore, ForcedUnwind, Outcome, Placement};
use crate::{MappedStack, STACK_ALIGNMENT, Suspension, arch};
...
#[test]
fn shared_outcomes_round_trip_through_the_block() {
